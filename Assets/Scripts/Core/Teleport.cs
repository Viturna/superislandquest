...
public class Teleport : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D col) {
        ...
        if (col.gameObject.tag == "Player") {
			...
			col.gameObject.GetComponent<PlayerManagerAnimated>().Teleport(x,y,numTableau); //On récupère le PlayerManager du joueur pour appeler la fonction de téléportation
